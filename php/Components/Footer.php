          ...
          <div class="grid grid-cols-2 gap-5 row-gap-8 lg:col-span-4 md:grid-cols-4">
            <div>
              ...
              <ul class="mt-2 space-y-2">
                <li><a href="/" class="transition-colors duration-300 text-gray-300 hover:text-teal-400">Residential</a></li>
                <li><a href="/" class="transition-colors duration-300 text-gray-300 hover:text-teal-400">Commercial</a></li>
                <li><a href="/" class="transition-colors duration-300 text-gray-300 hover:text-teal-400">Repairs</a></li>
                <li><a href="/" class="transition-colors duration-300 text-gray-300 hover:text-teal-400">Maintenance</a></li>
              </ul>
            </div>
            <div>
              <p class="font-semibold tracking-wide text-teal-400">
              ...
              <ul class="mt-2 space-y-2">
                <li><a href="/" class="transition-colors duration-300 text-gray-300 hover:text-teal-400">About Us</a></li>
                <li><a href="/" class="transition-colors duration-300 text-gray-300 hover:text-teal-400">Team</a></li>
                <li><a href="/" class="transition-colors duration-300 text-gray-300 hover:text-teal-400">Careers</a></li>
                <li><a href="/" class="transition-colors duration-300 text-gray-300 hover:text-teal-400">Safety</a></li>
              </ul>
            </div>
            <div>
              <p class="font-semibold tracking-wide text-teal-400">
