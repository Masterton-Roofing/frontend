...
<article class="bg-white py-12 px-4 sm:px-6 lg:px-8">
  <div class="max-w-3xl mx-auto">
    ...
    <header class="mb-8">
      <h1 class="text-4xl font-extrabold text-gray-900 mb-4">Masterton Roofing: Your Experts in PVC Membrane</h1>
      <div class="flex items-center text-gray-500 text-sm space-x-6">
        ...
        <div class="mb-8 overflow-hidden rounded-xl">
            <img src="/public/img/hero.jpg" alt="Masterton Roofing: Your Experts in PVC Membrane" class="w-full h-auto object-cover max-h-[400px]" />
        </div>

    <div class="prose prose-lg prose-blue max-w-none">
<h1>Masterton Roofing: Your Experts in PVC Membrane</h1>
    </div>
  </div>
</article>
<?php
